...
\033[1;92m[+] AUTHOR       :   SHAHIN MAHMUD 
\x1b[1;92m[+] FACEBOOK     :   William Albart 
\x1b[1;92m[+] GITHUB       :   technicalshahin
\x1b[1;12m[+] TEAM         :   \33[1;42  SH4H1N\33[0m
...
rp= 'SH4H1N '
x = 'TEAM SSS'
if 'SH4H1N'==user and 'TEAM SSS '==pas:
        Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL  ")
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/SHAHIN.MAHMUD.OFFICIAL.1973')
